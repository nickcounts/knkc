/* Chapter 13, Project 11
   ...
   Modify Chapter 7, Project 13 so that it includes the following function:

   double compute_average_word_length(const char *sentence);

   The function returns the average length of the words in the string pointed to by the sentence
 */

// Chapter 7, Project 13 (Original starts here)
...
void get_next_tok(const char *input, int i_start, tok_struct *ret_tok) {
...
// returns the average length of the words in the string pointed to by the
// sentence
double compute_average_word_length(const char *sentence){
  int num_toks = 0;
  int num_chars = 0;
  ...
  return (double)num_chars / (double) num_toks ;
}
